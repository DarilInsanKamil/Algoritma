...
main()
{
    ...
    case 1:
        ...
        cout << "Berapa buku yang ingin anda beli ";
        cin >> jumlah;
        ...
        if (uang >= buku)
        {
            ...
            kembalian = uang - jumlah * buku;
            // Mencetak variabel kembalian
            cout << "Kamu membeli " << jumlah << " Buku, sisa uang kamu " << kembalian << endl;
        }
    ...
    case 2:
        ...
        // Input nilai uang ke variabel uang
        cout << "Berapa pensil yang ingin anda beli ";
        cin >> jumlah;
        cout << "Masukan uang anda ";
        cin >> uang;
        ...
        if (uang >= pensil)
        {
            ...
            kembalian = uang - jumlah * pensil;
            // Mencetak variabel kembalian
            cout << "Kamu membeli " << jumlah << " Pensil, sisa uang kamu " << kembalian << endl;
        }
